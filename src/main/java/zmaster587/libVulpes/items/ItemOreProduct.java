		...
		try {
			...
			if(I18n.canTranslate(translate))
				...
				return I18n.translateToLocalFormatted(
						...
						I18n.translateToLocal("material." + properties.get(itemstack.getItemDamage()).getUnlocalizedName() + ".name"),
						I18n.translateToLocal("type." + outputType + ".name")
				);
			} catch (NullPointerException e2) {
			return I18n.translateToLocal("item.libvulpes.noName.name");
			}
	}
}
