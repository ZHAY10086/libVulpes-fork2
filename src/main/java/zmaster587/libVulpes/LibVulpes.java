...
@Mod(modid="libvulpes", name="Vulpes library", version="0.5.2", useMetadata=true, dependencies="after:ic2;after:cofhcore;after:buildcraft|core;after:immersiveengineering")
